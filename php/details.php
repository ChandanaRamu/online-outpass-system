...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/detailscs.css">
	<link rel="stylesheet" href="../css/header.css">
	<link rel="stylesheet" href="../css/wardennav.css">
    ...
    <body>
        ...
        <div id="user">
            <div class="navbar">
              ...
              <div>
                <div id="dbtn">
                    <center><a href="accept.php"><button  class="btn"><i class="fa fa-arrow-circle-left"></i> Back</button></a></center>
                </div>
                    <?php
                    $oi=$_GET['oi'];
                    if($_SESSION['empid']!='')
